        ...
        a.r(e),
          (e.default = {
            config: {
              title: 'antmjs Vantui',
              src: [
                '/Users/loclink/Project/vantui/packages/vantui/src',
                '/Users/loclink/Project/vantui/packages/vantui/docs',
              ],
              globalStyles: [
                '/Users/loclink/Project/vantui/packages/vantui/docs/theme.less',
              ],
              ...
              menu: [
                {
                  ...
                  items: [
                    ...
                    { path: 'custom-style', title: '样式覆盖' },
                    { path: 'theme', title: '定制主题' },
                    { path: 'use-in-react', title: '如何在React中使用' },
                    { path: 'contributing', title: '贡献指南' },
                    { path: 'v2-to-v3', title: 'v2升级到v3' },
                    { path: 'comments', title: 'typescript同步到文档' },
                    { path: 'premium', title: '高级模版功能说明' },
                  ],
                },
                {
                  name: '基础组件',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { path: 'form-render', title: 'FormRender 表单渲染器' },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { path: 'water-mark', title: 'WaterMark 水印' },
                    {
                    ...
                    { path: 'virtual-list', title: 'VirtualList 虚拟列表' },
                    { path: 'waterfall-flow', title: 'WaterfallFlow 瀑布流' },
                  ],
                },
                {
                  name: '导航组件',
